...
exports.updateUser = exports.resetPassword = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JzgpdBk2hS3b5Lb7ZuE2xRtHKyMrizRCQlbjZTbbmdsa7xaS7s7GSfUZRDONYA4r6LvjMMWZijWMQ1QgVoq6rIY00BPxcJLOy'); // 1) Get check-out session from API/Server
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout form nd charge credir card
...
var resetPasswordForm = document.querySelector('.form.form-user-password');
...
if (updateForm) {
  updateForm.addEventListener('submit', function (e) {
    ...
    (0, _updateUserData.updateUser)(formData);
  });
}
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _updateUserData.resetPassword)(passwordCurrent, password, passwordConfirm);
  });
}
